...
class iProjectorIncrementalSiddonMulti : public vProjector
{
  ...
  private:
    ...
    */
    ...
    /*!
      \fn      private int iProjectorIncrementalSiddonMulti::ProjectWithTOFPos()
      \param   int a_direction
      \param   oProjectionLine* ap_ProjectionLine
    ...
    */
    ...
    /*!
      \fn      private int iProjectorIncrementalSiddonMulti::ProjectWithTOFBin()
      \param   int a_direction
      \param   oProjectionLine* ap_ProjectionLine
  ...
  // Data members
  private:
    int m_nbLines; /*!< The number of lines that will be used for each event */
};
